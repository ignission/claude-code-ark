...
run_case claude_settings_inject "$repo" "$state"
assert_failure_reason "invalid settings schema rejected" "settings schema invalid: .claude/settings.local.json"
...
run_case claude_settings_inject "$repo" "$state"
assert_failure_reason "invalid failure hook schema rejected" "settings schema invalid: .claude/settings.local.json"
...
run_case claude_settings_inject "$repo" "$state"
assert_failure_reason "invalid SessionStart hook schema rejected" "settings schema invalid: .claude/settings.local.json"
