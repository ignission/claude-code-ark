...
5. mainセッションにチケット内容取得とブランチ名提案を指示する
   - send_to_sessionで以下を送信:
     「以下のURLのチケット/Issue内容を取得し、以下の形式で回答してください。\n\n## タスク要約\n- タイトル: ...\n- 説明: ...\n- 受入条件: ...（あれば）\n\n## ブランチ名提案\nURLの種別に応じた形式で1つ提案してください:\n- Jiraチケット（*.atlassian.net）: feature/PMDEV-XXX/slug\n- GitHub issue（github.com/.../issues/XXX）: feature/issue-XXX/slug\n\nURL: {ユーザーが貼ったURL}」
6. mainセッションの出力を監視する
